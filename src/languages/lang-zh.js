export default {
  ...
  game: {
      ...
      step4: {
        form: {
          ...
          reset: {
            ...
            tip: {
              name: '是否定期重置你的世界',
              force: '开启后会在设定的时间每日重置世界',
              time: '在这个时间执行重置操作',
              days: '强制重置关闭时生效，指连续x天(现实中的天，不是游戏中的8分钟)没有玩家进入游戏，就进行重置',
            },
          },
          keepalive: {
            name: '自动保活',
    ...
    player: {
      ...
      chat: {
        ...
        needTime: {
          text: '时间预测',
          tip: '饥荒管理平台通过开服时间预测聊天的真实时间，可能存在一天或几天的误差（服务器超过一天没进人），时分秒是精确的',
        },
        refresh: '刷新',
        type: {
          Announcement: '游戏宣告',
          BanAnnouncement: '玩家封禁',
          DeathAnnouncement: '玩家死亡',
          JoinAnnouncement: '玩家加入',
          KickAnnouncement: '玩家踢出',
          LeaveAnnouncement: '玩家离开',
          ResurrectAnnouncement: '玩家复活',
          RollAnnouncement: '玩家掷点',
          Say: '玩家聊天',
        ...
        vote: {
          ...
          'regenerate passed': '重置成功',
          'regenerate failed': '重置失败',
        },
        refreshSuccess: '刷新成功',
        autoPull: '自动刷新',
  ...
  platform: {
    ...
    settings: {
      ...
      form: {
        ...
        webhook: {
          ...
          tip: {
            name: '当触发指定事件时，向配置的 URL 发送 HTTP POST 通知，可指定仅对选中的房间生效',
          },
        },
      },
      noChange: '配置未修改',
    ...
    plugin: {
      ...
      search: {
        label: '搜索',
        placeholder: '可通过插件名搜索',
      },
      introduce: {
        info: '成功安装后，你可以在平台工具页面使用该插件',
        tmi: {
      ...
      install: {
        proxy: {
          name: '代理',
          tip: '插件需要从 GitHub 下载文件；如无法直连 GitHub，请填写代理地址，否则留空',
        },
        tmi: {
          proxy: {
            name: '代理',
  ...
  dashboard: {
    ...
    card3: {
      ...
      quickCmd: {
        ...
        player: '玩家',
        playerUid: '玩家ID',
        playerUidError: '请输入正确的玩家ID，以KU_开头',
        playerCmd: '玩家命令',
        world: '世界',
        worldCmd: '世界命令',
        playerOptions: {
    ...
    tmi: {
      ...
      cardCmd: {
        character: {
          ...
          moistureFull: '潮湿满',
          moistureZero: '潮湿零',
          playerTemperature25: '体温正常',
          playerTemperature70: '体温过热',
          playerTemperature0: '体温过冷',
          godMode: '上帝模式',
          creativeMode: '建造模式',
          oneHitKill: '一击必杀',
          invisible: '隐身模式',
          clearInventory: '清空物品栏',
          clearBackpack: '清空背包',
        },
        season: {
          title: '季节',
