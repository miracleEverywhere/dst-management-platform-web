      ...
      step4: {
        form: {
          ...
          webhook: {
            ...
            form: {
              name: 'Name',
              namePlaceholder: 'e.g. DingTalk Bot',
              nameRequired: 'Please enter a name',
              url: 'URL',
              urlPlaceholder: 'https://hooks.example.com/webhook',
              urlRequired: 'Please enter the webhook URL',
              events: 'Events',
              eventsRequired: 'Please select at least one event',
              secret: 'Secret (optional)',
              secretPlaceholder: 'For HMAC-SHA256 signature verification',
            },
            tip: {
              name: 'Send HTTP POST notification to the configured URL when specified events are triggered',
            },
          },
        },
      },
    ...
    settings: {
      ...
      form: {
        ...
        webhook: {
          ...
          form: {
            name: 'Name',
            namePlaceholder: 'e.g. Ops Notification',
            nameRequired: 'Please enter a name',
            url: 'URL',
            urlPlaceholder: 'https://hooks.slack.com/services/xxx',
            urlRequired: 'Please enter the webhook URL',
            events: 'Events',
            eventsRequired: 'Please select at least one event',
            secret: 'Secret (optional)',
            secretPlaceholder: 'For HMAC-SHA256 signature verification',
            roomIds: 'Target Rooms',
            roomIdsHint: 'Empty means all rooms',
          },
          tip: {
            name: 'Send HTTP POST notification to the configured URL when specified events are triggered. You can limit notifications to selected rooms.',
          },
        },
