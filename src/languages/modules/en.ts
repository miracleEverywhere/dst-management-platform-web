  ...
  setting: {
    ...
    mod: {
      ...
      add: {
        ...
        alert2: 'The mod here is not the same concept as the mods used in DST servers. Updating the mod here will not update the game mods in DST. For details, please refer to the documentation',
        table: {
          name: 'Name',
          size: 'Mod Size',
          downloadedReady: {
