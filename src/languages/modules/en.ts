export default {
  home: {
    ...
    customConnectionCodeTip: 'If your server has been proxied or forwarded, please enter the complete direct connection code below, e.g. c_connect(\'IP\', PORT)',
    customConnectionCodeTip2: 'If you want to disable the custom connection code, simply delete the content in the input box below and submit it.',
    submit: 'Submit',
    copy: 'Click to copy',
    cycles: "Cycles",
    phase: "Phase",
