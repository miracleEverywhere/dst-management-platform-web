export default {
  ...
  setting: {
    ...
    noEdit: 'No special requirements, please do not modify.',
    ...
    system: {
      ...
      tip1: 'The following are global settings that affect all clusters and can only be modified by administrators',
      tip2:'The following are cluster settings that affect the current cluster',
    },
  },
  tools: {
    install: {
